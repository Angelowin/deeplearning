...
import numpy as np
data_o = sio.loadmat('/media/jiming/_E/angelo/ALofauto/PaviaU.mat')['paviaU']
data = data_o[200:500, :300, :]
random.seed(50)  # 1,5,40,50,100,500，550，600，700，750
...
# vutils.save_image(data_new,
#             '/media/jiming/_E/angelo/Paper/degan_indian/dcgan/g_samples2.png',nrow=5,normalize=True)