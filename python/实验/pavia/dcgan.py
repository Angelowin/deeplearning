...
from Paper.degan_pavia.model.Discriminator import Discriminator
...
label = sio.loadmat('/media/jiming/_E/angelo/ALofauto/PaviaU_gt.mat')['paviaU_gt']
...
# plt.imshow(data,cmap='gray')
# plt.show()
random.seed(750)      #1,5,40,50,100,500，550，600，700，750
...
real = torch.FloatTensor(opt.batchSize, nc, 300, 300)
...
torch.save(netG.state_dict(), '%s/netG_pavia40-750.pth' % (opt.outf))
#torch.save(netD.state_dict(), '%s/netD_pavia20.pth' % (opt.outf))
